...
// Custom filter function with type assertion
function filterOptions(
  list: DataTableFacetedFilter['options'] | any[],
  term: string
): any[] {
  return (list as DataTableFacetedFilter['options']).filter((option) =>
